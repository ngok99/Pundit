...
(function(window, angular, undefined) {
  ...
  var urlBase = "http://sparkypolitics.tk/api";
 ...
 */
  module.factory(
      ...
      function(Resource, LoopBackAuth, $injector) {
        ...
        urlBase + "/Bills/:id",
          { 'id': '@id' },
          {
            ...
            // INTERNAL. Use Bill.likes.findById() instead.
            "prototype$__findById__likes": {
              params: {
                'fk': '@fk',
              },
              url: urlBase + "/Bills/:id/likes/:fk",
              method: "GET",
            },

            // INTERNAL. Use Bill.likes.destroyById() instead.
            ...
            // INTERNAL. Use Bill.likes.updateById() instead.
            ...
            // INTERNAL. Use Bill.likes() instead.
            "prototype$__get__likes": {
              isArray: true,
              url: urlBase + "/Bills/:id/likes",
              method: "GET",
            },

            // INTERNAL. Use Bill.likes.create() instead.
            "prototype$__create__likes": {
              url: urlBase + "/Bills/:id/likes",
              method: "POST",
            },

            // INTERNAL. Use Bill.likes.destroyAll() instead.
            "prototype$__delete__likes": {
              url: urlBase + "/Bills/:id/likes",
              method: "DELETE",
            },

            // INTERNAL. Use Bill.likes.count() instead.
            "prototype$__count__likes": {
              url: urlBase + "/Bills/:id/likes/count",
              method: "GET",
            },
            ...
            /**
             * @ngdoc method
             * @name lbServices.Bill#patchOrCreate
             * @methodOf lbServices.Bill
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.Bill#replaceOrCreate
             * @methodOf lbServices.Bill
             *
             * @description
             *
             ...
             */
            "replaceOrCreate": {
              url: urlBase + "/Bills/replaceOrCreate",
              method: "POST",
            },
            ...
            /**
             * @ngdoc method
             * @name lbServices.Bill#replaceById
             * @methodOf lbServices.Bill
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.Bill#prototype$patchAttributes
             * @methodOf lbServices.Bill
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.Bill#createChangeStream
             * @methodOf lbServices.Bill
             *
             * @description
             *
             ...
             */
            "createChangeStream": {
              url: urlBase + "/Bills/change-stream",
              method: "POST",
            },

            // INTERNAL. Use Likes.bill() instead.
            "::get::likes::bill": {
              url: urlBase + "/likes/:id/bill",
              method: "GET",
            },
          }
        );
        ...
        R["removeById"] = R["deleteById"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.Bill#updateAttributes
             * @methodOf lbServices.Bill
             *
             * @description
             *
    ...
    /**
     * @ngdoc object
     * @name lbServices.Bill.likes
     * @header lbServices.Bill.likes
     * @object
     * @description
     *
     * The object `Bill.likes` groups methods
     * manipulating `Likes` instances related to `Bill`.
     *
     * Call {@link lbServices.Bill#likes Bill.likes()}
     ...
     */
        ...
        R.likes = function() {
          ...
          var action = TargetResource["::get::Bill::likes"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Bill.likes#count
             * @methodOf lbServices.Bill.likes
             *
             * @description
             *
             * Counts likes of Bill.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - PersistedModel id
        ...
        R.likes.count = function() {
          var TargetResource = $injector.get("Likes");
          var action = TargetResource["::count::Bill::likes"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Bill.likes#create
             * @methodOf lbServices.Bill.likes
             *
             * @description
             *
        ...
        R.likes.create = function() {
          var TargetResource = $injector.get("Likes");
          var action = TargetResource["::create::Bill::likes"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Bill.likes#createMany
             * @methodOf lbServices.Bill.likes
             *
             * @description
             *
        ...
        R.likes.createMany = function() {
          var TargetResource = $injector.get("Likes");
          var action = TargetResource["::createMany::Bill::likes"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Bill.likes#destroyAll
             * @methodOf lbServices.Bill.likes
             *
             * @description
             *
        ...
        R.likes.destroyAll = function() {
          var TargetResource = $injector.get("Likes");
          var action = TargetResource["::delete::Bill::likes"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Bill.likes#destroyById
             * @methodOf lbServices.Bill.likes
             *
             * @description
             *
        ...
        R.likes.destroyById = function() {
          var TargetResource = $injector.get("Likes");
          var action = TargetResource["::destroyById::Bill::likes"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Bill.likes#findById
             * @methodOf lbServices.Bill.likes
             *
             * @description
             *
        ...
        R.likes.findById = function() {
          var TargetResource = $injector.get("Likes");
          var action = TargetResource["::findById::Bill::likes"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Bill.likes#updateById
             * @methodOf lbServices.Bill.likes
             *
             * @description
             *
        ...
        R.likes.updateById = function() {
          var TargetResource = $injector.get("Likes");
          var action = TargetResource["::updateById::Bill::likes"];
          return action.apply(R, arguments);
        };
      ...
      function(Resource, LoopBackAuth, $injector) {
        ...
        urlBase + "/likes/:id",
          { 'id': '@id' },
          {
            ...
            /**
             * @ngdoc method
             * @name lbServices.Likes#prototype$patchAttributes
             * @methodOf lbServices.Likes
             *
             * @description
             *
            ...
            // INTERNAL. Use Bill.likes.createMany() instead.
            "::createMany::Bill::likes": {
              isArray: true,
              url: urlBase + "/Bills/:id/likes",
              method: "POST",
            },
        ...
        R["removeById"] = R["deleteById"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.Likes#updateAttributes
             * @methodOf lbServices.Likes
             *
             * @description
             *
        ...
        */
        ...
        R.bill = function() {
          ...
          var action = TargetResource["::get::likes::bill"];
          return action.apply(R, arguments);
        };
